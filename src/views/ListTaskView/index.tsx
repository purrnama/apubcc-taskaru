      ...
      <div className="pt-8">
        <div className="min-h-12">
          <div className="flex flex-row justify-between">
            <div>
              <h1 className="text-2xl font-display font-normal text-white mb-12">List New Task</h1>
            </div>
            <div className="">
              <button className="btn btn-outline btn-gray ml-80">View on GitHub</button>
            </div>
          </div>
            ...
            <div className="card h-50 bg-white bg-opacity-10 shadow-xl">
              <div className="card-body">
                <p className="text-gray-400 text-xl">
                  Tasks are created by pulling data from issues in your Github repository. 
                  Taskaru will keep track of developments and sync any updates for this issue.
                </p>
              </div>
            </div>
