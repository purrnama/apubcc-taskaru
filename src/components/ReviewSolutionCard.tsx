      ...
      <div className="flex justify-between ...">
        ...
        <div className="card w-30 h-300 bg-white bg-opacity-5 bg-base-80 shadow-xl">
          <div className="btn-group">
            <input type="radio" name="options" data-title="Poor" className="btn" />
            <input type="radio" name="options" data-title="Good" className="btn" />
            <input type="radio" name="options" data-title="Great" className="btn" />
          </div>
        </div>
      </div>
    </div>
